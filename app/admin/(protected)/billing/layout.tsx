...
export default async function BillingLayout({ children }: { children: React.ReactNode }) {
  const session = await requireAnyPermission(["folio.view", "folio.invoice", "folio.refund_approve"]);
  ...
  return (
    <>
      <PageHeader
        title="Billing"
        description="Tax invoices, online payments and refund approvals across the property."
        action={
