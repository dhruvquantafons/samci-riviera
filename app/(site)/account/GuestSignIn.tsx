...
import { requestGuestCode, confirmGuestCode, type PortalState } from "../../lib/guest-portal";
 ...
 */
export default function GuestSignIn({ labels }: { labels: { emailCode: string; enterCode: string } }) {
